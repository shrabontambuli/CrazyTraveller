    ...
    return (
        <div>
            <div className='text-center mt-20'>
                ...
                <p className='w-9/12 mx-auto mt-6'>Whether you’re traveling with friends or joined a group tour, you’ll remember your trip long after saying goodbye at the airport. For many travelers, preserving these memories with photos is important. When group photos are on one phone, selfies on another, and the best shots of landmarks on a memory card or two, gathering photos from the entire group is a challenge. </p>
            </div>
