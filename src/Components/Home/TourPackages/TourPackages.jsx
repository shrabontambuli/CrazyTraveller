    ...
    return (
        <div>
            <div className='text-center mt-20'>
                ...
                <p className='w-9/12 mx-auto mt-6'>A package tour, package vacation, or package holiday comprises transport and accommodation advertised and sold together by a vendor known as a tour operator. Other services may be provided such as a rental car, activities or outings during the holiday.</p>
            </div>
            <div className='mt-20 grid grid-cols-1 lg:grid-cols-3 justify-items-center gap-8 container mx-auto'>
                <div className='div2 w-11/12'>
                    ...
                    <div className='flex justify-between items-center px-5 mt-8'>
                        <div>
                            ...
                            <p className='text-[#1E1E1E]'>10 days trip</p>
                        </div>
                        <div>
                ...
                <div className='div2 w-11/12'>
                    ...
                    <div className='flex justify-between items-center px-5 mt-8'>
                        <div>
                            <h1 className='text-black text-4xl font-serif'>Lahore, Lakistan</h1>
                            <p className='text-[#1E1E1E]'>6 days trip</p>
                        </div>
                        <div>
